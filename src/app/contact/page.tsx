        ...
        <div className="mt-14 grid gap-10 lg:grid-cols-5">
          ...
          <div className="lg:col-span-5">
            <a
              ...
              className="glass glass-hover flex flex-col items-center gap-3 rounded-3xl p-8 text-center sm:flex-row sm:gap-6 sm:text-left"
            >
              <div className="flex h-16 w-16 shrink-0 items-center justify-center rounded-2xl bg-[#6d8bff]/10">
                <svg className="h-8 w-8 text-[#6d8bff]" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25m-18 0A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75m-18 0v-7.5A2.25 2.25 0 015.25 9h13.5A2.25 2.25 0 0121 11.25v7.5" />
                </svg>
              </div>
              <div className="flex-1">
                <h3 className="text-xl font-semibold text-white">Book a free 30-min build call</h3>
                <p className="mt-1 text-[#a7b1d4]">
                  Pick a time that works. We&apos;ll discuss your project, budget, and timeline — no strings attached.
                </p>
              </div>
              <span className="btn-primary shrink-0 rounded-xl px-6 py-3 text-sm font-medium">
                Pick a time →
              </span>
            </a>
          </div>
